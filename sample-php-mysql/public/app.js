/* ==========================================================================
   Laravel PHP & MySQL Testing App - Frontend Client Logic
   ========================================================================== */
...
function initTheme() {
    ...
    const savedTheme = localStorage.getItem('laravel_theme') || 'dark';
    ...
    themeToggleBtn.addEventListener('click', () => {
        ...
        localStorage.setItem('laravel_theme', newTheme);
...
async function runDbBenchmark() {
    try {
        ...
        if (data.connected) {
            ...
            appendLog(`[PDO PING] Query Ping: ${data.pingMs}ms | MySQL Ver: ${data.mysqlVersion} | Tables: ${data.tableCount} | Items: ${data.recordsCount}`, 'success');
        } else {
